...
function createFakeServer() {
    return {
        getData: async () => {
            try {
                const response = await axios.get('https://randomuser.me/api/?inc=gender,name,nat,location,phone,email&results=1000');
                return {
                    success: true,
